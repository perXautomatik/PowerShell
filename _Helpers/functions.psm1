...
function Sanatize-path                          { param( $path='G:\mhk',$replaceChar='_') if (!$path -or !(Test-Path $path))                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             { throw "file not found: '$path'" } $regex= "[^\)\w \\\ -:.åäöÅ!@¤£é&=#§]"                                                                                                                                                                               ; Get -ChildItem $path -Recurse                                                         | Where -Object              {$_.name -match $regex}                            | rename -item -newName                                                                                                                                                                                                                                                                                                                                                                                                              {$_.name -replace $regex,$replaceChar}}
...
function ls { Get-Childitem}
 # ls -al is musclememory by now so ignore all args for this "alias"
