...
Add-Type -Path 'C:\Users\crbk01\Documents\PowerShell\Modules\ScriptBrowser\1.3.1.0\bin\ScriptBrowser.dll'
Add-Type -Path 'C:\Users\crbk01\Documents\PowerShell\Modules\ScriptBrowser\1.3.1.0\bin\BestPractices.dll'
